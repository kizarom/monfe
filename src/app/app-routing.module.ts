...
{ path: 'projets', component: ListProjectComponent, canActivate: [AuthGuard] },
  ...
  {path:"catalogue",component:CatalogComponent, canActivate: [AuthGuard]},
  {path:"panier",component:OrderComponent, canActivate: [AuthGuard]},

  // {path:"filterCommande",component:FilterCommandeComponent, canActivate: [AuthGuard]},
